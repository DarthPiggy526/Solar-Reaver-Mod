...
class CfgVehicles
{
	...
	class TIOW_MK7_Tact_SR_NL: TIOW_MK7_Tact_SR_BS
	{
		...
		{
			"SR_FirstBorn\Textures\NL_Armour1.paa",
...
class CfgWeapons
{
	...
	{
		author="Strixus";
		displayName="[TSR] MK 7 Power Armor (Night Lords)";
	...
	{
		author="Strixus";
		displayName="[TSR] MK 2 Pauldrons (Night Lords)";
		hiddenSelectionsTextures[] =
		{
			"SR_FirstBorn\Textures\NL_Armour1.paa",
			"SR_FirstBorn\Textures\SR_Armour2.paa"
	...
	{
		author="Strixus";
		displayName="[TSR] MK 7 Helmet (Night Lords)";
		hiddenSelectionsTextures[]=
		{
			"SR_FirstBorn\Textures\NL_Helmet.paa"
		};
	};
};