class CfgPatches
{
	class TIOW_Inf_SR_IronWarriors
	{
		requiredAddons[]=
		{
			"TIOW_Inf_SR"
...
class CfgVehicles
{
	...
	class TIOW_MK7_Tact_SR_IW: TIOW_MK7_Tact_SR_BS
	{
		author="Strixus";
		displayName="Tactical Marine (MK. VII)";
		uniformClass="SR_MK7_Armor_IronWarriors"; // This will be the classname of the PowerArmor, as seen in Weapons.HPP
...
class CfgWeapons
{
	...
	class SR_MK7_Helmet_IronWarriors: TIOW_MK7Helmet_UM
	{
		...
		hiddenSelectionsTextures[]=
		{
			"SR_FirstBorn\Textures\IW_Helmet.paa"
		};
	};
};