class CfgPatches
{
	class sr_sfx
	{
		...
		units[]=
		{
			"sr_module_electronic_alert_sys",
			"sr_module_sfx_blue_alert",
			"sr_module_sfx_red_alert",
			"sr_module_sfx_intruder_alert",
			"sr_module_sfx_evacuation_klaxon",
			"sr_module_sfx_electrical_arcs",
			"sr_module_sfx_trench_whistle",
			"sr_module_sfx_nid_laugh",
			"sr_module_sfx_nid_speech_1",
			"sr_module_sfx_nid_speech_2",
			"sr_module_sfx_nid_roar_1",
			"sr_module_sfx_nid_roar_2",
			"sr_module_sfx_nid_wheeze"
		};
		weapons[]=
		{
			""
...
class CfgSFX
{
	class sr_sfx_electronic_alert_sys
	{
		...
		sound1[]=
		{
			"sr_sfx\Sound\Electronic_Alert_system.ogg",
			5,
			1,
			200,
			1,
	...
	class sr_sfx_intruder_alert
	{
		...
		sound1[]=
		{
			"sr_sfx\Sound\intruder_alert.ogg",
			5,
			1,
			200,
			1,
	...
	class sr_sfx_evacuation_klaxon
	{
		...
		sound1[]=
		{
			"sr_sfx\Sound\evacuation_klaxon.ogg",
			5,
			1,
			200,
			1,
	...
	class sr_sfx_electrical_arcs
	{
		...
		sound1[]=
		{
			"sr_sfx\Sound\electrical_arcs.ogg",
			5,
			1,
			200,
			1,
	...
	class sr_sfx_trench_whistle
	{
		...
		sound1[]=
		{
			"sr_sfx\Sound\trench_whistle.ogg",
			5,
			1,
			50,
			1,
