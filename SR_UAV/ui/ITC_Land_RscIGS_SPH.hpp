		...
		class CA_IGUI_elements_group: RscControlsGroup {
			...
			class controls {
				...
				class crosshair_image: RscPicture {
					idc = 1800;
					text = "\SR_UAV\ui\data\crosshair_ca.paa";
					style = 2096;
					shadow = 0;					
				...
				class arrowLeft_image: RscPicture {
					idc = 1803;
					text = "\SR_UAV\ui\data\arrowmark_l.paa";
					style = 2096;
					shadow = 0;					
					x = "26 * 		(0.01875 * SafezoneH)";
					y = "(14) * 		(0.025 * SafezoneH)";
				...
				class arrowRight_image: RscPicture {
					idc = 1804;
					text = "\SR_UAV\ui\data\arrowmark_r.paa";
					style = 2096;
					shadow = 0;					
				...
				class arrowUp_image: RscPicture {
					idc = 1805;
					text = "\SR_UAV\ui\data\arrowmark_u.paa";
					style = 2096;
					shadow = 0;					
					x = "20.4 * 		(0.01875 * SafezoneH)";
				...
				class arrowDown_image: RscPicture {
					idc = 1806;
					text = "\SR_UAV\ui\data\arrowmark_d.paa";
					style = 2096;
					shadow = 0;					
					x = "20.4 * 		(0.01875 * SafezoneH)";
