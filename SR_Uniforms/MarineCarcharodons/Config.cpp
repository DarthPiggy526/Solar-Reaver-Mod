class CfgPatches
{
	class TIOW_Inf_SR_Charcharodons
	{
		requiredAddons[]=
		{
			"TIOW_Inf_SR"
...
class CfgWeapons
{
	...
	class SR_MK7_Armor_Charcharodons: TIOW_MK7PowerArmor_1_WS
	{
		author="Strixus";
	...
	class SR_MK2_Shoulders_Carcharodons : SR_MK2_Shoulders_Blackshield
	{
		...
		class SR_MK7_Helmet_Charcharodons : TIOW_MK7Helmet_UM
	  {
		author="Strixus";
		displayName = "MK 7 Helmet (TSR Charcharodons)";
