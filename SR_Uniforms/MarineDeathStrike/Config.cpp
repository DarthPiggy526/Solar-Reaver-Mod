...
class CfgVehicles
{
	...
	class TIOW_MK7_Tact_SR_DeathStrike: TIOW_MK7_Tact_SR_BS
	{
		author="Strixus";
		displayName="Tactical Marine (MK. VII)";
		uniformClass="SR_MK7_Armor_DeathStrike"; // This will be the classname of the PowerArmor, as seen in Weapons.HPP
...
class CfgWeapons
{
	...
	{
		author="Strixus";
		displayName="[SR] MK 7 Power Armor (TSR Death Strike)";
	...
	class SR_MK2_Shoulders_DeathStrike : SR_MK2_Shoulders_Blackshield
	{
		author="Strixus";
		displayName="[SR] MK 2 Pauldrons (TSR Death Strike)";
		hiddenSelectionsTextures[] =
		{
			"SR_Uniforms\Textures\DS_Armour1.paa",
			"SR_Uniforms\Textures\SR_Armour2.paa"
